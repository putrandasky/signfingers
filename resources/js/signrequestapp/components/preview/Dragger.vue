  ...
  export default {
    ...
    mounted() {
      this.$nextTick(function() {
        ...
        this.setCurrentSignArea(dragger)
    ...
    watch: {
      ...
      'parentPage.width': debounce(function(newVal, oldVal) {
        ...
        this.setCurrentSignAreaH(dragger)
      ...
      'parentPage.height': debounce(function(newVal, oldVal) {
        ...
        this.setCurrentSignAreaV(dragger)
    ...
    methods: {
      ...mapActions(['setCurrentSignArea', 'setCurrentSignAreaV', 'setCurrentSignAreaH', 'refreshDraggerInstance', 'setStep']),
