...
return [
    'meta' => [
        ...
        'description' => 'Digital signature for replacing conventional signing activities with digital. Signfinger provides free and secure digital signature platform without registration.',
        ...
        'og_description' => 'Digital signature for replacing conventional signing activities with digital. Signfinger provides free and secure digital signature platform without registration.',
    ...
    'why' => [
        ...
        'footnote' => '* No file stored for Self Signing feature. Sign Request feature using AES-256 encryption to keep your file securely stored and automatically deleted in 12 hours or already signed',
    ],
    ...
    'how-work' => [
        ...
        '2' => [
            'title' => 'Draw a signature on the browser',
            'subtitle' => 'Define an area as signature target on the document and draw your signature on the given pad in the platform',
        ],
        '3' => [
            'title' => 'Download it',
            'subtitle' => 'Preview it before download. If it is not as desired, just repeat it. simple',
        ],
    ],
    'cta' => [
